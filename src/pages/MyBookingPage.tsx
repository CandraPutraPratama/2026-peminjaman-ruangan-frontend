      ...
      <div className="p-8 max-w-7xl mx-auto">
        <header className="mb-12">
          ...
          <p className="text-slate-500 font-medium mt-1">
            Pantau dan kelola semua reservasi ruangan kamu disini.
          </p>
        </header>
        ...
        <div className="flex bg-slate-100 p-1.5 rounded-2xl w-fit mb-8 shadow-inner">
          <button
            ...
            className={`px-8 py-3 rounded-xl font-bold text-sm transition-all ${activeTab === "active" ? "bg-white text-blue-600 shadow-md" : "text-slate-500 hover:text-slate-700"}`}
          >
            Reservasi Aktif ({activeBookings.length})
          </button>
          <button
            onClick={() => setActiveTab("history")}
            className={`px-8 py-3 rounded-xl font-bold text-sm transition-all ${activeTab === "history" ? "bg-white text-red-600 shadow-md" : "text-slate-500 hover:text-slate-700"}`}
          >
            Riwayat Ruangan ({historyBookings.length})
          </button>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-100">
                <th className="p-6 font-black text-slate-400 uppercase text-[10px] tracking-widest pl-10">
                  Ruangan
                </th>
                <th className="p-6 font-black text-slate-400 uppercase text-[10px] tracking-widest text-center">
                  Waktu Mulai
                </th>
                <th className="p-6 font-black text-slate-400 uppercase text-[10px] tracking-widest text-center">
                  Waktu Selesai
                  ...
                  <td colSpan={4} className="p-20 text-center">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <p className="text-slate-400 font-bold">
                        Belum ada ruangan yang kamu booking.
                      </p>
                      <button
                        onClick={() => window.history.back()}
                        className="text-blue-600 font-black text-xs hover:underline uppercase tracking-tighter"
                      >
                  ...
                  >
                    ...
                    <td className="p-6 text-center">
                      {activeTab === "active" ? (
                        ...
                        <span className="bg-slate-100 text-slate-400 px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest">
                          Selesai
                        </span>
                      )}
                    </td>
